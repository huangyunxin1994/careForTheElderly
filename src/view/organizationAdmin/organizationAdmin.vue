            ...
            <div class="enroll-manage-container" ref="container">
              <div class="enroll-manage-container-handle">
                ...
                <div class="btnWrap selectItem">
                  <el-button type="primary" class="btn" @click="selectAll"
                    >查看全部</el-button
                  >
                  <el-button type="primary" class="btn" @click="newUser"
                    >新建用户</el-button
                  >
                </div>
              </div>
                ...
                >
                  <template slot-scope="scope">
                    <el-link
                      type="primary"
                      v-if="item.type == 'link'"
                      @click="userDetails(scope.$index, scope.row)"
                      v-html="arrFormatter(scope.row[item.name], item.name)"
                    ></el-link>
                    <div
                      v-else-if="
                        item.type == 'handle' && scope.row['account'] == 'admin'
                      "
                      align="center"
                    >
                    ...
                    >
                      <el-tooltip content="编辑" placement="top">
                        <el-button
                          ...
                          icon="el-icon-edit"
                          size="small"
                          @click="adminMess(scope.$index, scope.row)"
                        ></el-button>
                      </el-tooltip>
                    </div>
                    <p
...
export default {
  ...
  methods: {
    ...
    arrFormatter(value, name) {
      if (name == "sex") return value == 1 ? "男" : value == 0 ? "女" : "";
      else if (name == "multiplexMark")
        return value == 1 ? "是" : value == 0 ? "否" : "";
      else if (name == "isEnable")
        return value == 1
          ? '<span style="color:rgb(112, 182, 3);font-weight:bold">是</span>'
          : value == 2
          ? '<span style="color:#909399;font-weight:bold">否</span>'
          : value == 3
          ? '<span style="color:#67C23A;font-weight:bold">进行中</span>'
          : value == 4
          ? '<span style="color:#909399;font-weight:bold">已结束</span>'
          : "";
      else if (name == "equState")
        return value == 0
          ? '<span style="color:#f79898;font-weight:bold">离线</span>'
          : value == 1
          ? '<span style="color:rgb(112, 182, 3);font-weight:bold">在线</span>'
          : value == 2
          ? '<span style="color:#e6a23c;font-weight:bold">低电量</span>'
          : "";
      else return value;
    },
    //模糊搜索
